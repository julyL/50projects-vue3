...
function handleClick(): void {
  resPassword.value = generatePassword(hasLower.value, hasUpper.value, hasNumber.value, hasSymbol.value, length.value);
}
...
<template>
  <div class="body">
    <div class="container">
      ...
      <button id="generate" class="btn btn-large" @click="handleClick">生成密码</button>
    </div>
  </div>
</template>
