    ...
    <div id="panel" class="panel-container">
      <template v-if="!showRes">
        ...
        <div class="ratings-container">
          <div v-for="(img, index) in imgList" :key="index" class="rating" :class="[img.active ? 'active' : '']" @click="saveReview(img.rating, index)">
            <img :src="img.url" alt="" />
      ...
      <template v-else>
        ...
        <br />
        <strong
          >Feedback: <span style="color: red">{{ review }}</span></strong
        >
