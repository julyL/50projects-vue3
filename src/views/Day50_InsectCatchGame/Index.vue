...
function createInsect() {
  ...
  insect.innerHTML = `<img src="${curInsect.value.src}" alt="${curInsect.value.alt}" style="transform: rotate(${Math.random() * 360}deg)" />`;
...
<template>
  <div class="body">
    <div class="screen" :class="[start ? 'up' : '']">
      ...
      <button id="start-btn" class="btn" @click="start = true">Play Game</button>
    </div>
