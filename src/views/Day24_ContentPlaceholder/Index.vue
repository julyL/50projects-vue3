...
function getData() {
  ...
  info.srcOne = 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80';
  ...
  <div class="body">
    <div class="card">
      ...
      <div class="card-content">
        <h3 class="card-title" :class="[showPlaceHolder ? 'animated-bg animated-bg-text' : '']">
          {{ info.title }}
        </h3>
        ...
        <div class="author">
          ...
          <div class="author-info">
            <strong :class="[showPlaceHolder ? 'animated-bg animated-bg-text' : '']">{{ info.name }}</strong>
            <small :class="[showPlaceHolder ? 'animated-bg animated-bg-text' : '']">{{ info.date }}</small>
          </div>
        </div>
      </div>
    </div>
